...
namespace Library.SerializableDictionary
{
    ...
    public class DictionaryPropertyDrawer : PropertyDrawer
    {
        ...
        public static bool ShowPages => DEF_SHOW_PAGES;
        public static bool ShowSize => DEF_SHOW_SIZE;
        public static int PageCount => DEF_PAGE_COUNT;
        ...
        public override float GetPropertyHeight(SerializedProperty property, GUIContent label)
        {
            ...
            if (isExpanded.boolValue)
            {
                ...
                if (ShowPages)
                {
                    ...
                    height += EditorGUIUtility.singleLineHeight;
                    keysSize = Mathf.Min(keysSize, PageCount);
                }
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (list != null)
            {
                ...
                list.DoList(new Rect(nextRect.x, nextRect.y, nextRect.width, GetPropertyHeight(property, label) - offset), label, ShowPages, PageCount);
            }
        }
        ...
        private void List_drawHeaderCallback(Rect rect, GUIContent label)
        {
            ...
            EditorGUI.LabelField(rect, title + (ShowSize ? " [" + KeysValues.arraySize + "]" : ""));
        }
